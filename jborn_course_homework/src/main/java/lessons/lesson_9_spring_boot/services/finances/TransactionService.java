...
public class TransactionService implements AbstractService<Transaction, Long> {
     ...
     * through commitMoneyTransaction() method only
    ...
    public Transaction insert(Transaction transaction) {
        // thru commitMoneyTransaction() method only
     ...
     */
    @Transactional(propagation = Propagation.MANDATORY)
    public void transferMoney(Account toAccount, BigDecimal sum) throws AccountNotMatchException {
