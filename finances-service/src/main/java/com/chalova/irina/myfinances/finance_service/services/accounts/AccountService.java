package com.chalova.irina.myfinances.finance_service.services.accounts;
...
import com.chalova.irina.myfinances.finance_service.dao.accounts.AccountDao;
...
//    }
    ...
    public Account insert(Account account) throws AccountAlreadyExistsException {
        Account accountFromDb = findByUserNameAndName(account.getUserName(), account.getName());
...
//    }
    ...
    private Account findByUserNameAndName(String userName, String name) {
        return accountDao.findByUserNameAndName(userName, name).orElse(null);
    }
