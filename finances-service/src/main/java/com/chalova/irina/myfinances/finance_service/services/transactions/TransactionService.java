package com.chalova.irina.myfinances.finance_service.services.transactions;

import com.chalova.irina.myfinances.commons_service.exceptions.operation_failed.OperationFailedException;
import com.chalova.irina.myfinances.commons_service.services.AbstractService;
import com.chalova.irina.myfinances.finance_service.dao.transactions.CategoryDao;
import com.chalova.irina.myfinances.finance_service.dao.transactions.TransactionDao;
...
import com.chalova.irina.myfinances.finance_service.exceptions.accounts.AccountNotMatchException;
import com.chalova.irina.myfinances.finance_service.exceptions.transactions.CategoryNotFoundException;
import com.chalova.irina.myfinances.finance_service.exceptions.transactions.TransactionNotFoundException;
...
@Service
public class TransactionService implements AbstractService<AccountTransaction, Long> {
...
//    }
    public List<AccountTransaction> findAllByUserName(String userName) {
        return transactionDao.findAllByUserName(userName);
    }

    public List<AccountTransaction> findAllByUserNameToday(String userName) {
...
//        return transactionDao.findAllByUserIdToday(userId, beginTime, endTime);
        return transactionDao.findAllByUserNameToday(userName, beginTime, endTime);
    }

    public List<AccountTransaction> findAllByAccountId(Long accountId) {
    ...
    @Transactional
    @Override
    public AccountTransaction insert(AccountTransaction transaction) {
    ...
    public void deleteById(Long id) {
        AccountTransaction transactionFromDb = findById(id);
     ...
     */
    @Override
    public AccountTransaction updateDomainWithNewData(AccountTransaction transactionToUpdate, AccountTransaction updateData) {
    ...
    public void withdrawMoney(Account fromAccount, BigDecimal sum) throws AccountNotMatchException {
        AccountTransaction transactionFrom = createTransaction(fromAccount, Operation.CREDIT, sum.negate(), "transfer");
    ...
    public void transferMoney(Account toAccount, BigDecimal sum)
            throws AccountNotMatchException {
        AccountTransaction transactionTo = createTransaction(toAccount, Operation.DEBET, sum, "transfer");
